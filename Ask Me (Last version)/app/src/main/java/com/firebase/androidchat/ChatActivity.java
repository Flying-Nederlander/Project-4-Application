...
public class ChatActivity extends ListActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mFirebaseRef = new Firebase(MainActivity.getSERVER_URL()).child("chat/" + MainActivity.getRoom());
        getLocation();
        }
    ...
    public void onStart() {
        ...
        mChatListAdapter = new ChatListAdapter(mFirebaseRef.limit(50), this, R.layout.chat_message, mUsername, receivingUser, MainActivity.getPhoneId());
    ...
    class PopupItemListener implements PopupMenu.OnMenuItemClickListener {
        ...
        public boolean onMenuItemClick(MenuItem item) {
            if (!item.hasSubMenu()) {
                sendMessage(item.getTitle().toString(), MainActivity.getPhoneId(), item.getItemId());
            }
            return false;
        }
    }
